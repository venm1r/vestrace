...
export const changeScopePaths = [
  ...
  "docs/development-evidence/v1-g0-05-gate/p06-followup-screenshots/01-connection-created.png",
  "docs/development-evidence/v1-g0-05-gate/p06-followup-screenshots/02-model-register-console-form-blocked.png",
  "docs/development-evidence/v1-g0-05-gate/p06-followup-screenshots/03-both-models-registered.png",
  "docs/development-evidence/v1-g0-05-gate/p06-followup-screenshots/04-chat-default-set.png",
  "docs/development-evidence/v1-g0-05-gate/p06-followup-screenshots/05-settings-models-default-pre-restart.png",
  "docs/development-evidence/v1-g0-05-gate/p06-followup-screenshots/06-ag-ui-refusal-expected.png",
  "docs/development-evidence/v1-g0-05-gate/p06-followup-screenshots/07-connection-qualification-stuck-pre-restart.png",
  "docs/development-evidence/v1-g0-05-gate/p06-followup-screenshots/08-settings-models-default-post-restart.png",
  "docs/development-evidence/v1-g0-05-gate/p06-followup-screenshots/09-console-chat-model-registered.png",
  "docs/development-evidence/v1-g0-05-gate/p06-followup-screenshots/10-console-embedding-model-registered.png",
  "docs/development-evidence/v1-g0-05-gate/p06-followup-screenshots/11-models-list-after-reload.png",
  "docs/development-evidence/v1-g0-05-gate/p06-no-auth-run-test.txt",
  "docs/development-evidence/v1-g0-05-gate/p06-screenshots/p06-connections-create-failure.png",
  "docs/development-evidence/v1-g0-05-gate/p06-screenshots/p06-credentialed-create-failure.png",
  "docs/development-evidence/v1-g0-05-gate/p06-screenshots/p06-models-register-blocked.png",
  "docs/development-evidence/v1-g0-05-gate/p06-screenshots/p06-settings-default-model-post-restart.png",
  "docs/development-evidence/v1-g0-05-gate/p06-screenshots/p06-settings-default-model-pre-restart.png",
  ...
  "docs/superpowers/specs/2026-09-18-vestrace-v1-p06-followup-real-execution-design.md",
  "docs/superpowers/specs/2026-09-18-vestrace-v1-p06-real-execution-design.md",
